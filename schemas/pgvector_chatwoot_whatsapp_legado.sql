...
\restrict vatovAAuE1SmweRNimSXHOOjYgrlwmU7yyjtwIsXtuSR9xE2KcMUTY8WtH93Wah
...
--
-- Name: Banco de dados Promo; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Banco de dados Promo" (
    id integer NOT NULL,
    "Nome" text,
    "Telefone" text,
    "Email" text,
    "CPF" text,
    "Data Entrada" text,
    "Mensagem Lead" boolean,
    "Pausado" boolean,
    "Status" text,
    "Estilo" text,
    "Navio" text,
    "Quantidade de Pessoas" text,
    "Vendedor Responsável" text,
    "Hora Mensagem" text,
    "FollowUpStatus" text
);


ALTER TABLE public."Banco de dados Promo" OWNER TO postgres;

--
-- Name: Banco de dados Promo_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."Banco de dados Promo_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."Banco de dados Promo_id_seq" OWNER TO postgres;

--
-- Name: Banco de dados Promo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."Banco de dados Promo_id_seq" OWNED BY public."Banco de dados Promo".id;
...
--
-- Name: Banco de dados Promo id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Banco de dados Promo" ALTER COLUMN id SET DEFAULT nextval('public."Banco de dados Promo_id_seq"'::regclass);
...
--
-- Name: Banco de dados Promo PK_Banco de dados Promo; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Banco de dados Promo"
    ADD CONSTRAINT "PK_Banco de dados Promo" PRIMARY KEY (id);
...
\unrestrict vatovAAuE1SmweRNimSXHOOjYgrlwmU7yyjtwIsXtuSR9xE2KcMUTY8WtH93Wah
