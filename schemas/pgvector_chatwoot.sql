...
\restrict K9EdHyoe6Uzcm803j6v9cM81fkOZ7h2A0vRqI1Z5khVWoWhY9qb5aNMpO2tePLw
...
--
-- Name: rag_audit_stage; Type: TABLE; Schema: analytics; Owner: postgres
--

CREATE TABLE analytics.rag_audit_stage (
    batch_ref text NOT NULL,
    mes date NOT NULL,
    contact_id bigint NOT NULL,
    conversation_id bigint NOT NULL,
    conversation_display_id integer NOT NULL,
    lead_message_id bigint NOT NULL,
    lead_created_at timestamp without time zone NOT NULL,
    lead_content text NOT NULL,
    flag_multicard boolean NOT NULL,
    flag_objection boolean NOT NULL,
    flag_negative boolean NOT NULL,
    rag_window text NOT NULL,
    rag_denied_multicard boolean NOT NULL,
    rag_bad_tone boolean NOT NULL,
    rag_objection_handling boolean NOT NULL,
    rag_push_to_close boolean NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE analytics.rag_audit_stage OWNER TO postgres;

--
-- Name: rag_fup_stage; Type: TABLE; Schema: analytics; Owner: postgres
--

CREATE TABLE analytics.rag_fup_stage (
    batch_ref text NOT NULL,
    mes date NOT NULL,
    contact_id bigint NOT NULL,
    conversation_id bigint NOT NULL,
    conversation_display_id integer NOT NULL,
    negative_at timestamp without time zone NOT NULL,
    first_invalid_fup_at timestamp without time zone NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE analytics.rag_fup_stage OWNER TO postgres;

--
-- Name: rag_metrics_snapshot; Type: TABLE; Schema: analytics; Owner: postgres
--

CREATE TABLE analytics.rag_metrics_snapshot (
    id bigint NOT NULL,
    batch_ref text NOT NULL,
    ...
    total_leads_atendidos bigint DEFAULT 0 NOT NULL,
    leads_com_objecao bigint DEFAULT 0 NOT NULL,
    leads_perguntaram_multiplos_cartoes bigint DEFAULT 0 NOT NULL,
    erros_pagamento_multiplos_cartoes bigint DEFAULT 0 NOT NULL,
    leads_com_negativa bigint DEFAULT 0 NOT NULL,
    erros_tom_positivo_apos_negativa bigint DEFAULT 0 NOT NULL,
    erros_fup_apos_encerramento bigint DEFAULT 0 NOT NULL,
    proxy_objecao_sem_tratativa_v2 bigint DEFAULT 0 NOT NULL,
    pct_erro_pagamento_sobre_expostos numeric(10,2),
    pct_erro_tom_sobre_negativas numeric(10,2),
    pct_fup_apos_negativa numeric(10,2),
    pct_proxy_objecao_sem_tratativa_v2 numeric(10,2),
    pct_erro_pagamento_sobre_universo numeric(10,2),
    pct_erro_tom_sobre_universo numeric(10,2),
    pct_fup_sobre_universo numeric(10,2),
    source_payload jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT rag_metrics_snapshot_snapshot_scope_check CHECK ((snapshot_scope = ANY (ARRAY['TRIMESTRE'::text, 'MES'::text])))
);


ALTER TABLE analytics.rag_metrics_snapshot OWNER TO postgres;

--
-- Name: rag_metrics_snapshot_id_seq; Type: SEQUENCE; Schema: analytics; Owner: postgres
--

CREATE SEQUENCE analytics.rag_metrics_snapshot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE analytics.rag_metrics_snapshot_id_seq OWNER TO postgres;

--
-- Name: rag_metrics_snapshot_id_seq; Type: SEQUENCE OWNED BY; Schema: analytics; Owner: postgres
--

ALTER SEQUENCE analytics.rag_metrics_snapshot_id_seq OWNED BY analytics.rag_metrics_snapshot.id;


--
-- Name: rag_universe_stage; Type: TABLE; Schema: analytics; Owner: postgres
--

CREATE TABLE analytics.rag_universe_stage (
    batch_ref text NOT NULL,
    mes date NOT NULL,
    total_leads_atendidos bigint NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE analytics.rag_universe_stage OWNER TO postgres;
...
--
-- Name: camp_dpid_seq_3; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.camp_dpid_seq_3
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.camp_dpid_seq_3 OWNER TO postgres;
...
--
-- Name: conv_dpid_seq_3; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.conv_dpid_seq_3
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.conv_dpid_seq_3 OWNER TO postgres;
...
--
-- Name: cruzeiros; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.cruzeiros (
...
ALTER TABLE public.cruzeiros OWNER TO postgres;
...
--
-- Name: resposta_audio; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.resposta_audio (
    id integer NOT NULL,
...
ALTER TABLE public.resposta_audio OWNER TO postgres;

--
-- Name: resposta_audio_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.resposta_audio_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.resposta_audio_id_seq OWNER TO postgres;

--
-- Name: resposta_audio_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.resposta_audio_id_seq OWNED BY public.resposta_audio.id;
...
--
-- Name: rag_metrics_snapshot id; Type: DEFAULT; Schema: analytics; Owner: postgres
--

ALTER TABLE ONLY analytics.rag_metrics_snapshot ALTER COLUMN id SET DEFAULT nextval('analytics.rag_metrics_snapshot_id_seq'::regclass);
...
--
-- Name: resposta_audio id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.resposta_audio ALTER COLUMN id SET DEFAULT nextval('public.resposta_audio_id_seq'::regclass);
...
--
-- Name: rag_audit_stage rag_audit_stage_pkey; Type: CONSTRAINT; Schema: analytics; Owner: postgres
--

ALTER TABLE ONLY analytics.rag_audit_stage
    ADD CONSTRAINT rag_audit_stage_pkey PRIMARY KEY (batch_ref, lead_message_id);


--
-- Name: rag_fup_stage rag_fup_stage_pkey; Type: CONSTRAINT; Schema: analytics; Owner: postgres
--

ALTER TABLE ONLY analytics.rag_fup_stage
    ADD CONSTRAINT rag_fup_stage_pkey PRIMARY KEY (batch_ref, conversation_id);


--
-- Name: rag_metrics_snapshot rag_metrics_snapshot_batch_ref_snapshot_scope_period_sta_key; Type: CONSTRAINT; Schema: analytics; Owner: postgres
--

ALTER TABLE ONLY analytics.rag_metrics_snapshot
    ADD CONSTRAINT rag_metrics_snapshot_batch_ref_snapshot_scope_period_sta_key UNIQUE (batch_ref, snapshot_scope, period_start, period_end);


--
-- Name: rag_metrics_snapshot rag_metrics_snapshot_pkey; Type: CONSTRAINT; Schema: analytics; Owner: postgres
--

ALTER TABLE ONLY analytics.rag_metrics_snapshot
    ADD CONSTRAINT rag_metrics_snapshot_pkey PRIMARY KEY (id);


--
-- Name: rag_universe_stage rag_universe_stage_pkey; Type: CONSTRAINT; Schema: analytics; Owner: postgres
--

ALTER TABLE ONLY analytics.rag_universe_stage
    ADD CONSTRAINT rag_universe_stage_pkey PRIMARY KEY (batch_ref, mes);
...
--
-- Name: cruzeiros cruzeiros_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cruzeiros
    ADD CONSTRAINT cruzeiros_pkey PRIMARY KEY (id);
...
--
-- Name: resposta_audio resposta_audio_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.resposta_audio
    ADD CONSTRAINT resposta_audio_pkey PRIMARY KEY (id);
...
--
-- Name: idx_rag_audit_stage_batch_conv_time; Type: INDEX; Schema: analytics; Owner: postgres
--

CREATE INDEX idx_rag_audit_stage_batch_conv_time ON analytics.rag_audit_stage USING btree (batch_ref, conversation_id, lead_created_at);


--
-- Name: idx_rag_audit_stage_batch_flags; Type: INDEX; Schema: analytics; Owner: postgres
--

CREATE INDEX idx_rag_audit_stage_batch_flags ON analytics.rag_audit_stage USING btree (batch_ref, flag_multicard, flag_objection, flag_negative);


--
-- Name: idx_rag_audit_stage_batch_mes_contact; Type: INDEX; Schema: analytics; Owner: postgres
--

CREATE INDEX idx_rag_audit_stage_batch_mes_contact ON analytics.rag_audit_stage USING btree (batch_ref, mes, contact_id);


--
-- Name: idx_rag_fup_stage_batch_mes_contact; Type: INDEX; Schema: analytics; Owner: postgres
--

CREATE INDEX idx_rag_fup_stage_batch_mes_contact ON analytics.rag_fup_stage USING btree (batch_ref, mes, contact_id);


--
-- Name: idx_rag_metrics_snapshot_batch_scope_period; Type: INDEX; Schema: analytics; Owner: postgres
--

CREATE INDEX idx_rag_metrics_snapshot_batch_scope_period ON analytics.rag_metrics_snapshot USING btree (batch_ref, snapshot_scope, period_start, period_end);


--
-- Name: idx_rag_universe_stage_batch_mes; Type: INDEX; Schema: analytics; Owner: postgres
--

CREATE INDEX idx_rag_universe_stage_batch_mes ON analytics.rag_universe_stage USING btree (batch_ref, mes);
...
--
-- Name: idx_messages_sender_senderid_private_created; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_messages_sender_senderid_private_created ON public.messages USING btree (sender_type, sender_id, private, created_at);
...
\unrestrict K9EdHyoe6Uzcm803j6v9cM81fkOZ7h2A0vRqI1Z5khVWoWhY9qb5aNMpO2tePLw
